...
from src.yatsuneko.train_model_single import TrainModelSingle

PROJ_DIR = "/home/grahman/projects/birdman-analyses-final"
TABLE_FILE = f"{PROJ_DIR}/data/yatsuneko/processed/processed_tbl.train.biom"
...
@click.option("--beta-prior", default=2.0, type=float)
@click.option("--disp-scale", default=0.5, type=float)
