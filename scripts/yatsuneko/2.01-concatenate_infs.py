...
tbl = biom.load_table("data/yatsuneko/processed/processed_tbl.train.biom")

concatenation_name = "feature"
coords = {"feature": tbl.ids(axis="observation")}

inf_dir = "/panfs/grahman/birdman-analyses-final/yatsuneko/inferences"
...
all_inf.to_netcdf("results/yatsuneko/inf.train.nc")
