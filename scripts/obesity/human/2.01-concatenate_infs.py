...
tbl = biom.load_table("data/obesity/processed/human/processed_tbl.genus.biom")

concatenation_name = "feature"
coords = {"feature": tbl.ids(axis="observation")}

inf_dir = "/panfs/grahman/birdman-analyses-final/obesity/human/inferences_genus"
...
all_inf.to_netcdf("results/obesity/inf.genus.human.nc")
